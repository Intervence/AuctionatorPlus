...
--submenu: Data reset
 AtrL["Data reset"] = "Restablecer datos"
 AtrL["DATA_RESET_EXPLANATION"] = "Las siguientes opciones te ayudarán a borrar datos almacenados.\n"
                                  .."Normalmente solo lo necesitarás si los datos se corrompen."
 AtrL["Clear Scanning History"] = "Borrar historial de escaneos"
 AtrL["Clear Posting History"] = "Borrar historial de ventas"
 AtrL["Clear Stacking Preferences"] = "Borrar preferencias de apilamiento"
 AtrL["Clear Shopping Lists"] = "Borrar listas de compras"
 AtrL["CLEAR_SCANNED_CONFIRM_NOTICE2"] = "Esto borrará el historial de precios de todos los objetos\n"
                                         .."de todos tus personajes, incluso en otros servidores."
 AtrL["CLEAR_POST_CONFIRM_NOTICE2"] = "Borrará la información guardada de todos los objetos que has\n"
                                      .."vendido (mostrada en la pestaña 'Otro' tras escanear)."
 AtrL["CLEAR_STACK_PREF_NOTICE2"] = "Restablecerá tus preferencias de apilamiento a los valores\n"
                                    .."por defecto. Es una opción bastante segura."
 AtrL["CLEAR_SHOPLIST_NOTICE2"] = "Si invertiste mucho tiempo creando listas de compras detalladas,\n"
                                  .."tendrás que reconstruirlas desde cero."
 AtrL["Clear It!"] = "¡Borrar!"
 AtrL["Are you sure you want to clear the scanned prices database?"] = "¿Estás seguro de que quieres borrar la base de datos de precios escaneados?"
 AtrL["Are you sure you want to clear the posting history?"] = "¿Estás seguro de que quieres borrar el historial de ventas?"
 AtrL["Are you sure you want to clear your stacking preferences?"] = "¿Estás seguro de que quieres borrar tus preferencias de apilamiento?"
 AtrL["Are you sure you want to clear your shopping lists?"] = "¿Estás seguro de que quieres borrar tus listas de compras?"
...
--submenu: Shopping Lists
 ...
 AtrL["Name for your new shopping list"] = "Nombre para tu nueva lista de compras"
 AtrL["New"] = "Nuevo"
 AtrL["New name for this list"] = "Nuevo nombre para esta lista"
